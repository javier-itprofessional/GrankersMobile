...
const styles = StyleSheet.create({
  ...
  dropdownText: { fontFamily: FontFamily.body, fontSize: 16, color: Colors.golf.text, flex: 1 },
  ...
  searchInput: { fontFamily: FontFamily.body, flex: 1, fontSize: 15, color: Colors.golf.text, padding: 0 },
  ...
  dropdownItemText: { fontFamily: FontFamily.body, fontSize: 15, color: Colors.golf.text },
  loadingContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 12, paddingVertical: 24 },
  loadingText: { fontFamily: FontFamily.body, fontSize: 14, color: Colors.golf.textLight },
  emptyContainer: { paddingVertical: 24, alignItems: 'center' },
  emptyText: { fontFamily: FontFamily.body, fontSize: 14, color: Colors.golf.textLight },
  ...
  continueButtonText: { fontFamily: FontFamily.bodyBold, fontSize: 18, fontWeight: '700' as const, color: '#FFFFFF' },
  ...
  modalTitle: { fontFamily: FontFamily.heading, fontSize: 24, fontWeight: '700' as const, color: Colors.golf.text, textAlign: 'center', marginBottom: 8 },
  modalSubtitle: { fontFamily: FontFamily.body, fontSize: 15, color: Colors.golf.textLight, textAlign: 'center', lineHeight: 21, marginBottom: 24 },
  ...
  createNewButtonText: { fontFamily: FontFamily.bodyBold, fontSize: 16, fontWeight: '700' as const, color: '#FFFFFF' },
  divider: { height: 1, backgroundColor: Colors.golf.border, marginVertical: 24 },
  gamesListTitle: { fontFamily: FontFamily.bodySemi, fontSize: 14, fontWeight: '600' as const, color: Colors.golf.textLight, marginBottom: 12 },
  ...
  gameItemText: { fontFamily: FontFamily.bodySemi, fontSize: 15, fontWeight: '600' as const, color: Colors.golf.text },
});
